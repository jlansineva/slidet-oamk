...
return cljs.core.some.call(null,(function (p1__14500_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__14500_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__14501){
var map__14502 = p__14501;
var map__14502__$1 = cljs.core.__destructure_map.call(null,map__14502);
var request = map__14502__$1;
var response_format = cljs.core.get.call(null,map__14502__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__14504){
var map__14505 = p__14504;
var map__14505__$1 = cljs.core.__destructure_map.call(null,map__14505);
var request = map__14505__$1;
var response_format = cljs.core.get.call(null,map__14505__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__14503_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__14503_SHARP_);
}),formats);
});
/**
