...
var G__17654 = devtools.prefs.pref.call(null,v);
v = G__17654;
continue;
} else {
return v;
...
}catch (e17655){var _e__17377__auto__ = e17655;
return false;
}})();
...
}catch (e17657){var _e__17377__auto__ = e17657;
return false;
}})();
...
}catch (e17659){var _e__17377__auto__ = e17659;
return false;
}}
}
});
...
var vec__17661 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__17661,(0),null);
var name = cljs.core.nth.call(null,vec__17661,(1),null);
...
return cljs.core.some.call(null,(function (p1__17664_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17664_SHARP_);
}),template);
});
