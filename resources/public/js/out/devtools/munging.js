...
var o17552 = temp__5751__auto__;
var temp__5751__auto____$1 = (o17552["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o17553 = temp__5751__auto____$1;
return (o17553["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17370__auto__ = f;
return (o__17370__auto__["toString"]).call(o__17370__auto__);
} else {
return "";
}
}catch (e17554){var _ = e17554;
return "";
}});
...
try{var o__17370__auto___17556 = t;
(o__17370__auto___17556["cljs$lang$ctorPrWriter"]).call(o__17370__auto___17556,t,writer);
}catch (e17555){var __17557 = e17555;
}
...
var char_code = (function (){var o__17370__auto__ = (new String(char$));
return (o__17370__auto__["charCodeAt"]).call(o__17370__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17370__auto__ = String;
return (o__17370__auto__["fromCharCode"]).call(o__17370__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17558 = num_code;
switch (G__17558) {
case (1):
return (185);
...
var o__17370__auto__ = String;
return (o__17370__auto__["fromCharCode"]).call(o__17370__auto__,superscript_code);
});
/**
...
}catch (e17560){var _e__17377__auto__ = e17560;
return false;
}})())){
...
var vec__17561 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__17561,(0),null);
...
var len__4864__auto___17570 = arguments.length;
var i__4865__auto___17571 = (0);
while(true){
if((i__4865__auto___17571 < len__4864__auto___17570)){
args__4870__auto__.push((arguments[i__4865__auto___17571]));

var G__17572 = (i__4865__auto___17571 + (1));
i__4865__auto___17571 = G__17572;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17566){
var vec__17567 = p__17566;
var ns_detector = cljs.core.nth.call(null,vec__17567,(0),null);
...
var G__17573 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__17574 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__17573;
remaining_tokens = G__17574;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17564){
var G__17565 = cljs.core.first.call(null,seq17564);
var seq17564__$1 = cljs.core.next.call(null,seq17564);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17565,seq17564__$1);
}));
...
var vec__17578 = cljs.core.split_with.call(null,(function (p1__17577_SHARP_){
return cljs.core.not_EQ_.call(null,p1__17577_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__17578,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__17578,(1),null);
...
var vec__17584 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__17584,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__17584,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__17587 = cljs.core.rest.call(null,remaining_tokens);
var G__17588 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__17587;
name_tokens = G__17588;
continue;
} else {
...
var vec__17591 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__17591,(0),null);
var arity = cljs.core.nth.call(null,vec__17591,(1),null);
var vec__17594 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__17594,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__17594,(1),null);
var vec__17597 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__17597,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__17597,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__17597,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__17597,(3),null);
...
var vec__17603 = result;
var munged_ns = cljs.core.nth.call(null,vec__17603,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__17603,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__17603,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__17603,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__17603,(4),null);
var arity = cljs.core.nth.call(null,vec__17603,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__17607 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__17607,(0),null);
var args = cljs.core.nth.call(null,vec__17607,(1),null);
var vec__17610 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__17610,(0),null);
var name = cljs.core.nth.call(null,vec__17610,(1),null);
...
var G__17613 = (arity + (1));
var G__17614 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17615){
var vec__17616 = p__17615;
var arity = cljs.core.nth.call(null,vec__17616,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__17616,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17619_SHARP_){
return cljs.core.get.call(null,arities,p1__17619_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__17620_SHARP_){
return cljs.core.drop.call(null,(2),p1__17620_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___17627 = arguments.length;
var i__4865__auto___17628 = (0);
while(true){
if((i__4865__auto___17628 < len__4864__auto___17627)){
args__4870__auto__.push((arguments[i__4865__auto___17628]));

var G__17629 = (i__4865__auto___17628 + (1));
i__4865__auto___17628 = G__17629;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17623){
var vec__17624 = p__17623;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__17624,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17621){
var G__17622 = cljs.core.first.call(null,seq17621);
var seq17621__$1 = cljs.core.next.call(null,seq17621);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17622,seq17621__$1);
}));
...
var map__17632 = options;
var map__17632__$1 = cljs.core.__destructure_map.call(null,map__17632);
var include_ns_QMARK_ = cljs.core.get.call(null,map__17632__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__17632__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__17632__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__17632__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17633 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__17633,(0),null);
var fn_name = cljs.core.nth.call(null,vec__17633,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__17633,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__17633,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__17633,(4),null);
var arity = cljs.core.nth.call(null,vec__17633,(5),null);
...
var o__17370__auto__ = f;
return (o__17370__auto__["getBasis"]).call(o__17370__auto__);
});
/**
...
}catch (e17636){var _e__17377__auto__ = e17636;
...
var G__17637 = (obj[cljs.core.first.call(null,path)]);
var G__17638 = cljs.core.rest.call(null,path);
obj = G__17637;
path = G__17638;
continue;
} else {
...
var _STAR_ = (function (accum,p__17639){
var vec__17640 = p__17639;
var bit = cljs.core.nth.call(null,vec__17640,(0),null);
var protocol = cljs.core.nth.call(null,vec__17640,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17643){
var vec__17644 = p__17643;
var ns = cljs.core.nth.call(null,vec__17644,(0),null);
var name = cljs.core.nth.call(null,vec__17644,(1),null);
var selector = cljs.core.nth.call(null,vec__17644,(2),null);
...
var post_process = (function (p__17648){
var vec__17649 = p__17648;
var munged_name = cljs.core.nth.call(null,vec__17649,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__17649,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17647_SHARP_){
return (obj[cljs.core.first.call(null,p1__17647_SHARP_)]);
}),sorted_matches);
