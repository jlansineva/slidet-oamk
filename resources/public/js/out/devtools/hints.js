...
var map__20203 = top_item;
var map__20203__$1 = cljs.core.__destructure_map.call(null,map__20203);
...
}catch (e20202){var _e = e20202;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___20204 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___20204)){
var seen_errors_20205 = temp__5751__auto___20204;
if(cljs.core.truth_(seen_errors_20205.has(self))){
} else {
seen_errors_20205.add(self);

var temp__5753__auto___20206 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___20206)){
var sense_20207 = temp__5753__auto___20206;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20207)].join(''));
} else {
}
}
} else {
