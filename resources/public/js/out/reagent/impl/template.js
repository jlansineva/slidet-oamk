...
var G__14543 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__14543,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__14547 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__14547,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__14548__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__14548 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__14549__i = 0, G__14549__a = new Array(arguments.length -  0);
while (G__14549__i < G__14549__a.length) {G__14549__a[G__14549__i] = arguments[G__14549__i + 0]; ++G__14549__i;}
  args = new cljs.core.IndexedSeq(G__14549__a,0,null);
} 
return G__14548__delegate.call(this,args);};
...
return G__14548__delegate(args);
});
...
var G__14551 = props;
var G__14551__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__14551,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14551);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14551__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__14552 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__14552,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__14552;
}
})(),id_class);
...
var G__14553 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14553) {
case (0):
...
var vec__14555 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14555,(0),null);
var id = cljs.core.nth.call(null,vec__14555,(1),null);
var className = cljs.core.nth.call(null,vec__14555,(2),null);
...
var temp__5757__auto___14558 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___14558 == null)){
} else {
var key_14559 = temp__5757__auto___14558;
(jsprops.key = key_14559);
}
...
var temp__5757__auto___14560 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___14560 == null)){
} else {
var key_14561 = temp__5757__auto___14560;
(jsprops.key = key_14561);
}
...
var temp__5757__auto___14562 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___14562 == null)){
} else {
var key_14563 = temp__5757__auto___14562;
(jsprops.key = key_14563);
}
...
var temp__5757__auto___14564 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___14564 == null)){
} else {
var key_14565 = temp__5757__auto___14564;
(jsprops.key = key_14565);
}
...
var temp__5757__auto___14566 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___14566 == null)){
} else {
var key_14567 = temp__5757__auto___14566;
(jsprops.key = key_14567);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__14568_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__14568_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14569 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__14569,(0),null);
var derefed = cljs.core.nth.call(null,vec__14569,(1),null);
...
break;
default:
var G__14574 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__14575 = compiler;
v = G__14574;
compiler = G__14575;
continue;
...
var G__14576 = tag;
var G__14576__$1 = (((G__14576 instanceof cljs.core.Keyword))?G__14576.fqn:null);
switch (G__14576__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template14579 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template14579 = (function (opts,id,fn_to_element,parse_fn,meta14580){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14579.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14581,meta14580__$1){
var self__ = this;
var _14581__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14579(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14580__$1));
}));

(reagent.impl.template.t_reagent$impl$template14579.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14581){
var self__ = this;
var _14581__$1 = this;
return self__.meta14580;
}));

(reagent.impl.template.t_reagent$impl$template14579.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14579.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14579.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template14579.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14579.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14579.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta14580","meta14580",305535151,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template14579.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14579.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14579");

(reagent.impl.template.t_reagent$impl$template14579.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write.call(null,writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template14579");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14579.
 */
reagent.impl.template.__GT_t_reagent$impl$template14579 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template14579(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14580){
return (new reagent.impl.template.t_reagent$impl$template14579(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta14580));
});

}

return (new reagent.impl.template.t_reagent$impl$template14579(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
