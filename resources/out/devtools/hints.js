...
var map__20205 = top_item;
var map__20205__$1 = cljs.core.__destructure_map.call(null,map__20205);
...
var column = cljs.core.get.call(null,map__20205__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e20204){var _e = e20204;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___20206 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___20206)){
var seen_errors_20207 = temp__5751__auto___20206;
if(cljs.core.truth_(seen_errors_20207.has(self))){
} else {
seen_errors_20207.add(self);

var temp__5753__auto___20208 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___20208)){
var sense_20209 = temp__5753__auto___20208;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20209)].join(''));
} else {
}
}
} else {
