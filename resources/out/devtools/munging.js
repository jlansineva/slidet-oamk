...
var o17554 = temp__5751__auto__;
var temp__5751__auto____$1 = (o17554["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o17555 = temp__5751__auto____$1;
return (o17555["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17372__auto__ = f;
return (o__17372__auto__["toString"]).call(o__17372__auto__);
} else {
return "";
}
}catch (e17556){var _ = e17556;
return "";
}});
...
try{var o__17372__auto___17558 = t;
(o__17372__auto___17558["cljs$lang$ctorPrWriter"]).call(o__17372__auto___17558,t,writer);
}catch (e17557){var __17559 = e17557;
}
...
var char_code = (function (){var o__17372__auto__ = (new String(char$));
return (o__17372__auto__["charCodeAt"]).call(o__17372__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17372__auto__ = String;
return (o__17372__auto__["fromCharCode"]).call(o__17372__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17560 = num_code;
switch (G__17560) {
case (1):
return (185);
...
var o__17372__auto__ = String;
return (o__17372__auto__["fromCharCode"]).call(o__17372__auto__,superscript_code);
});
/**
...
}catch (e17562){var _e__17379__auto__ = e17562;
return false;
}})())){
...
var vec__17563 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__17563,(0),null);
...
var len__4864__auto___17572 = arguments.length;
var i__4865__auto___17573 = (0);
while(true){
if((i__4865__auto___17573 < len__4864__auto___17572)){
args__4870__auto__.push((arguments[i__4865__auto___17573]));

var G__17574 = (i__4865__auto___17573 + (1));
i__4865__auto___17573 = G__17574;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17568){
var vec__17569 = p__17568;
var ns_detector = cljs.core.nth.call(null,vec__17569,(0),null);
...
var G__17575 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__17576 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__17575;
remaining_tokens = G__17576;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17566){
var G__17567 = cljs.core.first.call(null,seq17566);
var seq17566__$1 = cljs.core.next.call(null,seq17566);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17567,seq17566__$1);
}));
...
var vec__17580 = cljs.core.split_with.call(null,(function (p1__17579_SHARP_){
return cljs.core.not_EQ_.call(null,p1__17579_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__17580,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__17580,(1),null);
...
var vec__17586 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__17586,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__17586,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__17589 = cljs.core.rest.call(null,remaining_tokens);
var G__17590 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__17589;
name_tokens = G__17590;
continue;
} else {
...
var vec__17593 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__17593,(0),null);
var arity = cljs.core.nth.call(null,vec__17593,(1),null);
var vec__17596 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__17596,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__17596,(1),null);
var vec__17599 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__17599,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__17599,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__17599,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__17599,(3),null);
...
var vec__17605 = result;
var munged_ns = cljs.core.nth.call(null,vec__17605,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__17605,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__17605,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__17605,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__17605,(4),null);
var arity = cljs.core.nth.call(null,vec__17605,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__17609 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__17609,(0),null);
var args = cljs.core.nth.call(null,vec__17609,(1),null);
var vec__17612 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__17612,(0),null);
var name = cljs.core.nth.call(null,vec__17612,(1),null);
...
var G__17615 = (arity + (1));
var G__17616 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17617){
var vec__17618 = p__17617;
var arity = cljs.core.nth.call(null,vec__17618,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__17618,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17621_SHARP_){
return cljs.core.get.call(null,arities,p1__17621_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__17622_SHARP_){
return cljs.core.drop.call(null,(2),p1__17622_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___17629 = arguments.length;
var i__4865__auto___17630 = (0);
while(true){
if((i__4865__auto___17630 < len__4864__auto___17629)){
args__4870__auto__.push((arguments[i__4865__auto___17630]));

var G__17631 = (i__4865__auto___17630 + (1));
i__4865__auto___17630 = G__17631;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17625){
var vec__17626 = p__17625;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__17626,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17623){
var G__17624 = cljs.core.first.call(null,seq17623);
var seq17623__$1 = cljs.core.next.call(null,seq17623);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17624,seq17623__$1);
}));
...
var map__17634 = options;
var map__17634__$1 = cljs.core.__destructure_map.call(null,map__17634);
var include_ns_QMARK_ = cljs.core.get.call(null,map__17634__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__17634__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__17634__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__17634__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17635 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__17635,(0),null);
var fn_name = cljs.core.nth.call(null,vec__17635,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__17635,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__17635,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__17635,(4),null);
var arity = cljs.core.nth.call(null,vec__17635,(5),null);
...
var o__17372__auto__ = f;
return (o__17372__auto__["getBasis"]).call(o__17372__auto__);
});
/**
...
}catch (e17638){var _e__17379__auto__ = e17638;
...
var G__17639 = (obj[cljs.core.first.call(null,path)]);
var G__17640 = cljs.core.rest.call(null,path);
obj = G__17639;
path = G__17640;
continue;
} else {
...
var _STAR_ = (function (accum,p__17641){
var vec__17642 = p__17641;
var bit = cljs.core.nth.call(null,vec__17642,(0),null);
var protocol = cljs.core.nth.call(null,vec__17642,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17645){
var vec__17646 = p__17645;
var ns = cljs.core.nth.call(null,vec__17646,(0),null);
var name = cljs.core.nth.call(null,vec__17646,(1),null);
var selector = cljs.core.nth.call(null,vec__17646,(2),null);
...
var post_process = (function (p__17650){
var vec__17651 = p__17650;
var munged_name = cljs.core.nth.call(null,vec__17651,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__17651,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__17649_SHARP_){
return (obj[cljs.core.first.call(null,p1__17649_SHARP_)]);
}),sorted_matches);
